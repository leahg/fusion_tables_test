...
function getData(response) {
  ...
  for(i = 0; i < numRows; i++) {
    for(j = 0; j < numCols; j++) {
      fusiontabledata += "<td class="+response.getDataTable().getValue(i, 3)+"><a href='javascript:myFTclick("+i+")'>"+response.getDataTable().getValue(i, j) + "</a></td>";
    }
    fusiontabledata += "</tr><tr>";
  }
...
*/
    ...
    for (var i = 0; i < dt.getNumberOfRows(); i++) {
      ...
      //var html = "<strong>" + name + "</strong><br /><br/>" + type;
